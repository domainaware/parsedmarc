...
- Aggregate-report policy and authentication result words are now normalized to lowercase, so reporters that emit values such as `Pass` no longer create duplicate result categories ([#288](https://github.com/domainaware/parsedmarc/issues/288)).
