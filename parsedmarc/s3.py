...
class S3Client(object):
    ...
    def __init__(
        self, bucket_name, bucket_path, region_name, endpoint_url, access_key_id, secret_access_key
    ):
        """
    ...
    def save_report_to_s3(self, report, report_type):
        ...
        logger.debug(
            "Saving {0} report to s3://{1}/{2}".format(report_type, self.bucket_name, object_path)
        )
        object_metadata = {
